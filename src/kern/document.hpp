...
namespace Xem
{
  __INLINE DocumentHead& Document::getDocumentHead()
  {
#if PARANOID
  ...
  __INLINE ElementId Document::getFreeElementId ()
  {
#if 0
  ...
  __INLINE RoleId Document::getRoleId ()
  {
    return roleId;
  }
  
  __INLINE void Document::setRoleId ( RoleId _roleId )
  {
  ...
  __INLINE String Document::getRole ()
  {
    return String(getKeyCache().getLocalKey(roleId));
  }

  __INLINE void Document::setRole ( const String& role )
  {
  ...
  __INLINE void Document::processDomEvent ( XProcessor& xproc, DomEventType eventType, NodeRef& nodeRef )
  {
