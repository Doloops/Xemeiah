...
namespace Xem
{
    ...
    __INLINE
    Mutex::Mutex (const String& _name)
    {
        init();
    ...
    __INLINE
    Mutex::Mutex (const String& _name, void* obj)
    {
        init();
    ...
    __INLINE
    Mutex::Mutex (const String& _name, __ui64 idx)
    {
        init();
