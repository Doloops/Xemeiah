...
namespace Xem
{
    ...
    VolatileDocument*
    Store::createVolatileDocument (DocumentAllocator& documentAllocator)
    {
    ...
    void
    VolatileDocument::releaseDocumentResources ()
    {
