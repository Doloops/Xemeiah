...
namespace Xem
{
  ...
  public:
     ...
     * detail exception
     */
    virtual void doAppendMessage ( const char* file, const char* function, int line, const char* format, ...) __attribute__((format(printf,5,6)));
