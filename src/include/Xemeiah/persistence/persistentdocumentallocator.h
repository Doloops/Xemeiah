...
namespace Xem
{
  ...
  protected:
     ...
     */
    Store& getStore() const { return persistentStore; }
     ...
     */
    RevisionPage* getRevisionPage() const;
    
    /**
     * Alter the RevisionPage
     */
    INLINE void alterRevisionPage ();

    /**
     * Protect the RevisionPage
     */
    INLINE void protectRevisionPage ();

    /**
     *
     */
    BranchRevId getBranchRevId();
     ...
     */
    void allocateAreaMap ( __ui64 areaIdx );
     ...
     */
    void* mapAreaFromFile ( __ui64 areaIdx, AbsolutePagePtr offset );

    /**
     * Get a SegmentPage from its relPagePtr
     */
    SegmentPage* getRelativePage ( RelativePagePtr relPagePtr );
     ...
     */
    void mapRelativePages ( void* area, RelativePagePtr relPagePtr, AbsolutePagePtr absPagePtr, __ui64 count );
     ...
     */
    AbsolutePagePtr __getFreePagePtr ( PageType pageType );
    ...
    INLINE PageClass* getAbsolutePage ( AbsolutePagePtr absPagePtr );
     ...
     */
    INLINE IndirectionPage* getIndirectionPage ( IndirectionPagePtr indirectionPagePtr );
     ...
     */
    INLINE PageInfoPage* getPageInfoPage ( AbsolutePagePtr pageInfoPagePtr );

    /**
     *
     */
    INLINE void alterPageInfo ( PageInfo& pageInfo );

    /**
     *
     */
    INLINE void protectPageInfo ( PageInfo& pageInfo );
     ...
     */
    INLINE PageList* getPageList ( AbsolutePagePtr pageListPtr );
     ...
     */
    INLINE RevisionPage* getRevisionPage ( AbsolutePagePtr revisionPagePtr );
     ...
     */
    INLINE SegmentPage* getSegmentPage ( AbsolutePagePtr segmentPagePtr );

    /**
     * Release an absolute page ptr
     */
    INLINE void releasePage ( AbsolutePagePtr absPagePtr );
     ...
     */
    IndirectionPagePtr getFreeIndirectionPagePtr ( bool reset = false );
     ...
     */
    PageInfoPagePtr getFreePageInfoPagePtr ( bool reset = false );
     ...
     */
    INLINE bool doGetPageInfoPage ( RelativePagePtr relativePagePtr, PageInfoPage*& pageInfoPage, __ui64& index, bool write );
  ...
  public:
    ...
    public:
      ...
      PageInfoIterator& operator++ ( int i )
      {
        idx++;
        relPagePtr += PageSize;
