...
namespace Xem
{
  ...
  protected:
     ...
     */
    PersistentDocumentAllocator& getPersistentDocumentAllocator () const
    { return dynamic_cast<PersistentDocumentAllocator&> ( getDocumentAllocator() ); }

    /**
     * Bind the document allocator for garbage collection
     */
    void bindDocumentAllocator ( PersistentDocumentAllocator* allocator ) { Document::bindDocumentAllocator ( allocator ); }
     ...
     */
    PersistentDocument ( Store& store, PersistentDocumentAllocator& persistentDocumentAllocator, DocumentOpeningFlags flags );
     ...
     * Get the journalHead
     */
    JournalHead& getJournalHead ();

    /**
     * Alter the journal head
     */
    void alterJournalHead () { getPersistentDocumentAllocator().alterRevisionPage() ; }
    void protectJournalHead () { getPersistentDocumentAllocator().protectRevisionPage() ; }
     ...
     */
    virtual void releaseDocumentResources ();

    virtual bool isJournalEnabled() { return false; }
  public:
    /**
     * Get our DocumentCreationFlags
     */
    DocumentOpeningFlags getDocumentOpeningFlags() { return documentOpeningFlags; }
     ...
     */
    BranchFlags getBranchFlags () { return getPersistentDocumentAllocator().getBranchFlags(); }

    /**
     * Get the current branch name
     */
    String getBranchName () { return getPersistentDocumentAllocator().getBranchName(); }
     ...
     */
    void merge ( XProcessor& xproc, bool keepBranch );
     ...
     * Yes, we need to.
     */
    virtual bool deletionImpliesLockBranchManager() { return true; }
    ...
    { return getPersistentDocumentAllocator().checkContents(); }
