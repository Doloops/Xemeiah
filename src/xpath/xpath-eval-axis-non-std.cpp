...
namespace Xem
{
  void XPath::evalAxisRoot ( __XPath_Functor_Args )
  {
  ...
  void XPath::evalAxisHome ( __XPath_Functor_Args )
  {
    NotImplemented ( "Home.\n" );
  }

  void XPath::evalAxisVariable ( __XPath_Functor_Args )
  {
  ...
  void XPath::evalAxisResource ( __XPath_Functor_Args )
  {
    /*
  ...
  void XPath::evalAxisConstInteger ( __XPath_Functor_Args )
  {
    result.setSingleton ( step->constInteger );
  }

  void XPath::evalAxisConstNumber ( __XPath_Functor_Args )
  {
    result.setSingleton ( ((Number) step->constNumber ) );
  }

  void XPath::evalAxisBlob ( __XPath_Functor_Args )
  {
